...
class AddRecordForm(forms.ModelForm):
    ...
    notes = forms.CharField(required=False, widget=forms.Textarea(attrs={"placeholder":"Notes", "class":"form-control", "rows":3}), label="")

    class Meta:
        model = Record
        fields = ('first_name', 'last_name', 'email', 'phone', 'address', 'city', 'state', 'zipcode', 'notes')
